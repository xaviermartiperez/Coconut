...
#Correct the names so that the GWAS correspond to the correct version
correct_gwas_info_1 <- sub("\\.tsv$", paste0("_", genome, ".tsv"), gwas_info[1,1])
correct_gwas_info_2 <- sub("\\.tsv$", paste0("_", genome, ".tsv"), gwas_info[1,2])
